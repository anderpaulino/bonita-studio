...
public class Well extends Composite {
    ...
    public Well(final Composite parent, final String text, final FormToolkit toolkit, final int severity) {
        ...
        addPaintListener(new PaintListener() {
            ...
            public void paintControl(final PaintEvent e) {
                ...
                e.gc.setBackground(backgroundrColor(toolkit, severity));
        ...
        label.setBackground(backgroundrColor(toolkit, severity));
    ...
    private Color separatorColor(final FormToolkit toolkit, final int style) {
        ...
        return toolkit.getColors().getColor(IFormColors.SEPARATOR);
    }

    private Color backgroundrColor(final FormToolkit toolkit, final int style) {
        switch (style) {
            case IStatus.INFO:
        ...
        return toolkit.getColors().getColor(IFormColors.H_HOVER_LIGHT);
    }
